 ...
 */
class CategoriaList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $filter->setValue(TSession::getValue('Categoria_nome'));
        ...
        $new_button->setAction(new TAction(array('CategoriaForm', 'onEdit')), _t('New'));
        ...
        $edit_action   = new TDataGridAction(array('CategoriaForm', 'onEdit'));
